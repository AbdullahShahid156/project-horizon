...
async def generate_landing_page(data: LandingPagePromptRequest, user: str = Depends(get_current_user)):
    ...
    fallback_content = {
        ...
        "problem": {
            ...
            "points": [
                "Manual workflows drain your team's productivity and morale",
                "Disconnected tools create data silos and costly errors",
                f"Scaling {industry} operations requires hiring more people, not working smarter",
                "Competitors using modern tools are leaving you behind",
            ],
        },
        "solution": {
            ...
            "highlights": [
                ...
                "Unified dashboard gives you complete visibility and control",
                "Enterprise-grade security with 99.9% guaranteed uptime",
                f"Seamless integrations with your existing {industry} tools",
            ],
        },
        "benefits": [
            {"title": "Save Time", "description": "Automate manual processes and reclaim 10+ hours every week. Spend less time on busywork, more time on strategy.", "icon": "Clock"},
            {"title": "Reduce Costs", "description": "Cut operational costs by up to 40% while improving output quality. No more expensive manual bottlenecks.", "icon": "DollarSign"},
            {"title": "Scale Faster", "description": "Grow without limits. Our platform handles 10x your current workload without breaking a sweat.", "icon": "TrendingUp"},
            {"title": "Work Smarter", "description": "AI-powered insights surface opportunities you'd miss manually. Make data-driven decisions every time.", "icon": "Brain"},
        ...
        "guarantee": {
            ...
            "description": f"Try {pn} risk-free for 30 days. If you're not completely satisfied, we'll refund every penny — no questions asked.",
            "icon": "ShieldCheck",
        },
        "faq": [
            ...
            {"question": f"What kind of support does {pn} offer?", "answer": "We offer email support for all plans, priority support (4-hour response time) for Professional, and a dedicated account manager for Enterprise. Our help center has 500+ articles and video tutorials."},
            {"question": "Can I cancel my subscription anytime?", "answer": "Absolutely. There are no long-term contracts. Cancel anytime from your dashboard and you'll keep access until the end of your billing period. We also offer a 30-day money-back guarantee."},
        ],
        "finalCta": {
